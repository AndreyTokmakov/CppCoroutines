    ...
    void eventLoop()
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < eventsCount; ++i) {
                const EpollAwaiter* awaiter = static_cast<EpollAwaiter*>(events[i].data.ptr);
                ::epoll_ctl(epoll_fd, EPOLL_CTL_DEL, awaiter->fd, nullptr);
                awaiter->coroHandle.resume();
            }
        }
    }
}

void StdCoroutines::Networking::TcpClientEpoll_2::TestAll()
{
